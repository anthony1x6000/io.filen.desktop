...
- [Installation](#installation)
  - [Method 1: Install from the Flatpak repository (automatic updates)](#method-1-install-from-the-flatpak-repository-automatic-updates)
  - [Method 2: Install from standalone .flatpak bundle](#method-2-install-from-standalone-flatpak-bundle)
